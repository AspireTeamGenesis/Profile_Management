...
namespace PMS_API{
    public class Context:DbContext{
        ...
        {
        optionsBuilder.UseSqlServer("server=ASPLAP1929;database=PMS_ServiceTest1;trusted_connection=true;");
        }
         ...
         protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CountryCode>()
             ...
             modelBuilder.Entity<ProfileHistory>()
                        .HasData(
                         ...
                         new ProfileHistory { ProfileHistoryId = 3, ProfileId = 6 , ApprovedDate = new System.DateTime(2022,10,19) ,  IsActive = true},
                         new ProfileHistory { ProfileHistoryId = 4, ProfileId = 10 , ApprovedDate = new System.DateTime(2022,12,27) , IsActive = true}
                         );
            modelBuilder.Entity<Skills>()
                        .HasData(
                         ...
                         new Skills { SkillId = 5, ProfileId = 5 , TechnologyId = 10 , DomainId = 1 , IsActive = true},
                         new Skills { SkillId = 6, ProfileId = 1 , TechnologyId = 8 , DomainId = 10, IsActive = true},
                         new Skills { SkillId = 7, ProfileId = 9 , TechnologyId = 6 , DomainId = 8 , IsActive = true},
                         new Skills { SkillId = 8, ProfileId = 10 , TechnologyId = 4 , DomainId = 5 , IsActive = true},
                         new Skills { SkillId = 9, ProfileId = 8 , TechnologyId = 3 , DomainId = 9 , IsActive = true},
                         new Skills { SkillId = 10, ProfileId = 6 , TechnologyId = 9 , DomainId = 4 , IsActive = true}             
                        );
