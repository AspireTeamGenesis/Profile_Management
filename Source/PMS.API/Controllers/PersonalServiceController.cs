...
namespace PMS_API
{
    ...
    public class PersonalServiceController : Controller
    {
        ...
        public IActionResult AddProfile(Profile profile)
        {
            ...
            {
                _logger.LogInformation($"PersonalServiceController:AddProfile()-{exception.Message}{exception.StackTrace}");
        ...
        public IActionResult GetPersonalDetailsByProfileId(int Profileid)
        {
            try{
                ...
                return Ok(_personalService.GetPersonalDetailsByProfileId(Profileid));
            }
            catch(Exception exception){
                _logger.LogInformation($"PersonalServiceController :GetPersonalDetailsByProfileId()- exception occured while fetching record{exception.Message}{exception.StackTrace}");
               return BadRequest(exception.Message);
            }
        }
        ...
        public IActionResult GetAllEducationDetailsByProfileId(int Profileid)
        {
            try{
                ...
                return Ok(_personalService.GetAllEducationDetailsByProfileId(Profileid));
            }
            catch(Exception exception){
                _logger.LogInformation($"PersonalServiceController :GetAllEducationDetailsByProfileId()- exception occured while fetching record{exception.Message}{exception.StackTrace}");
               return BadRequest(exception.Message);
            }
        }
        [HttpPut]
        ...
        public IActionResult GetAllProjectDetailsByProfileId(int Profileid)
        {
            try{
                ...
                return Ok(_personalService.GetAllProjectDetailsByProfileId(Profileid));
            }
            catch(Exception exception){
                _logger.LogInformation($"PersonalServiceController :GetAllProjectDetailsByProfileId()- exception occured while fetching record{exception.Message}{exception.StackTrace}");
               return BadRequest(exception.Message);
            }
        }
        ...
        public IActionResult GetAllSkillDetailsByProfileId(int Profileid)
        {
            try{
                ...
                return Ok(_personalService.GetAllSkillDetailsByProfileId(Profileid));
            }
            catch(Exception exception){
                _logger.LogInformation($"PersonalServiceController :GetAllSkillDetailsByProfileId()- exception occured while fetching record{exception.Message}{exception.StackTrace}");
               return BadRequest(exception.Message);
            }
        }
