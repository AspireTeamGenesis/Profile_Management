        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 10, "IT", null, null, "BTech", 2022, true, 85f, 10, 2018, null, null, 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, "October", 2019, true, 1, "October", 2018, null, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6395), true, "English", 1, true, true, null, null, true },
                    { 2, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6408), true, "Tamil", 2, true, true, null, null, true },
                    { 3, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6409), true, "Hindi", 3, true, true, null, null, true },
                    { 4, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6410), true, "Telugu", 4, true, true, null, null, true },
                    { 5, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6411), true, "Malayalam", 5, true, true, null, null, true },
                    { 6, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6412), true, "Kannada", 3, true, true, null, null, true },
                    { 7, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6413), true, "Bengali", 4, true, true, null, null, true },
                    { 8, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6414), true, "Marathi", 3, true, true, null, null, true },
                    { 9, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6414), true, "Urdu", 1, true, true, null, null, true },
                    { 10, null, new DateTime(2022, 6, 28, 9, 47, 37, 673, DateTimeKind.Local).AddTicks(6415), true, "French", 2, true, true, null, null, true }
                });
