    ...
    public partial class test3 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7864), true, "English", 1, true, true, null, null, true },
                    { 2, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7877), true, "Tamil", 2, true, true, null, null, true },
                    { 3, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7878), true, "Hindi", 3, true, true, null, null, true },
                    { 4, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7879), true, "Telugu", 4, true, true, null, null, true },
                    { 5, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7880), true, "Malayalam", 5, true, true, null, null, true },
                    { 6, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7881), true, "Kannada", 3, true, true, null, null, true },
                    { 7, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7882), true, "Bengali", 4, true, true, null, null, true },
                    { 8, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7883), true, "Marathi", 3, true, true, null, null, true },
                    { 9, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7883), true, "Urdu", 1, true, true, null, null, true },
                    { 10, null, new DateTime(2022, 7, 5, 23, 33, 6, 535, DateTimeKind.Local).AddTicks(7885), true, "French", 2, true, true, null, null, true }
                });
        }
    }
}
